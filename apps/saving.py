...
def writeIntoModelRegistry(model_experiments_record, model_params, model_perf_fig_drt):
    ...
    checkpoint = {"model_experiments_record":model_experiments_record, "model_params":model_params, "model_perf_fig_drt":model_perf_fig_drt}
